...
class From1950to2100():                                                                 #//
  ...
  def __init__(self,option,var,y1,y2,colorbar,basin):                                            #//
     ...
     if basin != 'undefined':
       ...
       self.output_fileH = str(var)+'M_'+str(basin)+'_'+str(self.y1h)+'-'+str(self.y2h)+'_'+str(colorbar)                                #//
       self.output_fileF = str(var)+'M_'+str(basin)+'_'+str(self.y1f)+'-'+str(self.y2f)+'_'+str(colorbar)                                #//
     else:
       self.output_fileC = str(var)+'M_10yAnomaly_'+str(self.y1h)+'-'+str(self.y1f)+'_'+str(colorbar)                                #//
       self.output_fileH = str(var)+'M_'+str(self.y1h)+'-'+str(self.y2h)+'_'+str(colorbar)                                #//
       self.output_fileF = str(var)+'M_'+str(self.y1f)+'-'+str(self.y2f)+'_'+str(colorbar)                                #//
