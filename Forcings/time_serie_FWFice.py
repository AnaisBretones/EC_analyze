...
print(np.nanmin(FWF_region),np.nanmax(FWF_region))
...
var_fc_time(FWF_region[index_y1:index_y2+1],var,time[index_y1:index_y2+1],simu.first_year,lat_min,simu.output_file,basin)
