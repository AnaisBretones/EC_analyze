...
basin ='greenland_sea'		# arctic_ocean, BS_and_KS, greenland_sea, Siberian_seas, undefined
...
if comparison == 'no':
   if var == 'IceC':
     ...
     make_plot.time_serie_two_axis(mean_region_simu[:,index_y1:index_y2-1],var,time[index_y1:index_y2-1],sea_ice_extent,\
