...
class From1950to2100():									#//
  ...
  def __init__(self,option,var,y1,y2,compa,lat_min,basin,basin2,month):				#//
     ...
     self.path = '/media/fig010/LACIE SHARE/EC_Earth/EC_data/section2300/'+str(month)+'_Ice_'\
                  +str(option)+'.nc' 
...
file = open('/media/fig010/LACIE SHARE/EC_Earth/EC_data/section2300/Septembre_Sea_ice_extent_'+str(y1)+'to'+str(y2)+'_'+str(option)+'.txt','w')
