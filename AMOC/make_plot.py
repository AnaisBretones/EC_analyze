...
def one_sec(var,var2,variable_name,x,z,zmax,year,option,minline,maxline,title,colorbar):
   ...
   cs1=plt.contour(x,z,var, [4,11],linewidths=0.5)
   cs2=plt.contour(x,z,var2, [4,11],linewidths=2)
#   plt.clabel(cs1, colors='k',inline=True, fmt={-5:'-5', 0.:'0',4:'2', 5:'5',10:'10'},fontsize=9)
#   plt.clabel(cs2, inline=True, fmt={-5:'-5', 0.:'0',4:'2', 5:'5',10:'10'},fontsize=9)
   plt.clabel(cs1, inline=True, fmt={4:'4',11:'11'},fontsize=9)
   plt.clabel(cs2, inline=True, fmt={4:'4',11:'11'},fontsize=9)
   plt.ylim([np.min(z),z[-2]])
